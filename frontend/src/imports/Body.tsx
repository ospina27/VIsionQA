import svgPaths from "./svg-j8oojv4c8e";
...
export default function Body() {
  return (
    <div className="bg-[#131313] content-stretch flex flex-col items-start pb-[43.02px] pl-[256px] pt-[64px] relative size-full" data-name="Body">
      <MainContentCanvas />
