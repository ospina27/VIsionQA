  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col ml-16 xl:ml-56 pt-14 xl:pt-16">
        ...
        {/* ── Header ── */}
        <div className="absolute top-0 left-0 right-0 h-14 xl:h-16 backdrop-blur-xl bg-[rgba(30,64,175,0.8)] border-b-2 border-[rgba(59,130,246,0.3)] shadow-[0px_0px_30px_0px_rgba(59,130,246,0.2)] flex items-center justify-between px-6 z-50">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="bg-[rgba(59,130,246,0.1)] border border-[rgba(59,130,246,0.2)] rounded-sm px-2 py-0.5">
                <div className="text-[#3b82f6] font-['Inter'] font-bold text-[10px]">DICCIONARIO_VISUAL</div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-32 flex items-end gap-2">
                    {[45, 55, 68, 72, 85, 92, 98].map((height, i) => (
                      <div
                        key={i}
                        className={`flex-1 rounded-t transition-all ${i === 6 ? "bg-[#ef4444]" : "bg-[#3b82f6]"}`}
                        style={{ height: `${height}%` }}
                      />
                    ))}
                  </div>
